...
namespace Smart_Closet
{
    ...
    public class insertActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            insertBTN.Click += async (object sender, EventArgs e) =>
            {
                ...
                try
                {
                    ...
                    connection.Open();
                    //SqlCommand command = new SqlCommand("INSERT INTO ALI (color) VALUES('10');", connection);
                    //SqlCommand command = new SqlCommand("INSERT INTO ITEMS (COLOR, WEATHER, TYPE, FIRSTINSERT, LASTACT, IMAGE, NUMOFSELECTS, INCLOSET, USERNAME) VALUES( '" + radioButtonColor.Text + "' , '" + radioButtonWeath.Text + "' , '" + radioButtonType.Text + "' ,GetDate(),GetDate(),NULL,0,1,'NULL');", connection);
                    ...
                    //SqlCommand command = new SqlCommand("INSERT INTO ITEMS (COLOR, WEATHER, FIRSTINSERT, LASTACT, IMAGE, NUMOFSELECTS, INCLOSET, USERNAME) VALUES( "+radioButtonColor.Text+" , "+radioButtonWeath.Text+" ,GetDate(),GetDate(),NULL,0,1,NULL);", connection);
        ...
        protected override void OnActivityResult(int requestCode, [GeneratedEnum] Result resultCode, Intent data)
        {
            ...
            imageView2.SetImageBitmap(bitmapT);*/
